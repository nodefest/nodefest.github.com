var sponsors = {
  ...
  "gold": [
    ...
    },
    {
      ...
      "name": "株式会社リクルート",
      "logo": "recruit.png",
      "description": "リクルートは、「じゃらん」「SUUMO」「リクナビ」を初めとする大小様々なWebサービスを展開しています。これらのWebサービスを支えるアーキテクチャとして、Solr・Hadoop等オープンソースを積極的に活用しており、現在、リアルタイムWebの実現に向けNode.jsの導入に取り組んでいます。",
      "link": "http://www.recruit.co.jp/"
    }
  ],
